...
contract SimpleArtistToken is CustomERC721Metadata, WhitelistedRole {
    ...
    string public applicationScript;
    ...
    function updateApplicationScript(string memory _applicationScript) public onlyWhitelisted returns (bool) {
        applicationScript = _applicationScript;
        return true;
    }
